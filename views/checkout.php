<?php
   ...
   if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Card payment nam payment page ekata yanna
...
<head>
  ...
  <title>Checkout - Auraclothing.lk</title>
  <!-- Bootstrap 5 CSS -->
          ...
          <form method="post" action="">            
            ...
            <div class="mb-3">
              ...
              <select class="form-select" id="paymentMethod" name="payment_method" required>
                ...
                <option value="card" <?php echo (isset($_POST['payment_method']) && $_POST['payment_method'] === 'card') ? 'selected' : ''; ?>>online card payment</option>
        
              </select>
            </div>            
            <button class="btn btn-primary w-100 py-2 fs-5 mt-2" type="submit" <?php echo empty($cart_items) ? 'disabled' : ''; ?>>
