...
<head>
    ...
    <title>Shop - Auraclothing.lk</title>
    <!-- Bootstrap 5 CSS -->
    ...
    <style>
        :root {
            --primary: #0c4c88; /* Tailwind green-700 */
            --secondary: #0c2b3a; /* Tailwind green-600 */
            --light: #F0FFF4; /* Tailwind green-50 */
            --accent: #fcd423; /* Tailwind yellow-300 */
...
<body>
    ...
    <?php include_once('../includes/nav.php'); ?>    <section class="shop-hero-section py-5">
        <div class="container">
            <h1 class="shop-title mb-4 text-center">Shop clothes</h1>
