...
<head>
    ...
    <title>User Profile - Auraclothig.lk</title>
    <!-- Bootstrap CSS -->
    ...
    <link href="https://cdn.jsdelivr.net/npm/sweetalert2@11.7.5/dist/sweetalert2.min.css" rel="stylesheet">    <style>
        :root {
            --primary: #09466e; /* Tailwind green-700 */
            --secondary: #076abb; /* Tailwind green-600 */
